...
const MARCAS_MODELOS = {
  ...
  Peugeot: ["206", "207", "208", "3008", "2008", "408", "Partner", "Expert", "5008"],
  Ford: ["Fiesta", "Focus", "EcoSport", "Ranger", "Ka", "Mondeo"],
  Chevrolet: ["Corsa", "Onix", "Cruze", "Tracker", "S10", "Spin", "Trailblazer", "Terrytory"],
  Volkswagen: ["Gol", "Polo", "Virtus", "T-Cross", "Amarok", "Vento"],
  Renault: ["Clio", "Sandero", "Kangoo", "Duster", "Fluence", "Logan"],
  Fiat: ["Uno", "Palio", "Cronos", "Toro", "500", "Strada", "Argo", "Mobi", "Punto", "Siena"],
  Honda: ["Civic", "Fit", "HR-V", "CR-V", "City", "Accord", "WR-V"],
  Nissan: ["March", "Versa", "Sentra", "Frontier", "Kicks", "Note", "X-Trail"],
